...
function insertStatCliAbn($id_client){
    ...
    $db = $dbHandler->openConnection();
    $sql = "SELECT mise_a_jour_donnee_abonnee(".$data_imf['coef_montant_max'].",".$coeff_present42.",".$data_imf['palier_montant_max_normal'].", ".$data_imf['palier_montant_max_salarie'].",".$coeff_def_irregularite.");";
