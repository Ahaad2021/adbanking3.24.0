...
function ajoutParamIMF($DATA){
    global $dbHandler, $global_id_agence;
    $db = $dbHandler->openConnection();
    $result = executeQuery($db, buildInsertQuery("ml_imf", $DATA));
...
function getDataMlIMF(){
    global $dbHandler, $global_id_agence;
    $db = $dbHandler->openConnection();

    $sql = "SELECT * from ml_imf;";
...
function modifParamIMF($DATA){
    global $dbHandler, $global_id_agence;
    $db = $dbHandler->openConnection();

    $result = executeQuery($db, buildUpdateQuery("ml_imf", $DATA));
