...
// Appelle de la fonction de mise a jour des donnees clients
        $db = $dbHandler->openConnection();
        $sql = "SELECT mise_a_jour_donnee_abonnee_v3(".$data_imf['coef_montant_max'].",".$coeff_present42.",".$data_imf['palier_montant_max_normal'].", ".$data_imf['palier_montant_max_salarie'].",".$coeff_def_irregularite.");";
        $result = $db->query($sql);
        if (DB::isError($result)) {
