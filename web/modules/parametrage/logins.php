...
//  $MyPage->setButtonProperties("modAssoc", BUTP_AXS, 297);
  ...
  if($AG['duree_pwd'] > 0){
    if (isEngraisChimiques()) {
      $liste_champ = array("login", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_retrait", "depasse_plafond_depot", "langue","is_agent_ec", "profil");
        ...
        $liste_champ = array("login", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_retrait", "depasse_plafond_depot", "langue", "profil","n_agence","n_guichet");
    }
    else{
    ...
    if (isEngraisChimiques()) {
      $liste_champ = array("login", "have_left_frame", "billet_req", "depasse_plafond_retrait", "depasse_plafond_depot", "langue","is_agent_ec", "profil");
        ...
        $liste_champ = array("login", "have_left_frame", "billet_req", "depasse_plafond_retrait", "depasse_plafond_depot", "langue", "profil","n_agence","n_guichet");
    }
    else{
  ...
  if($AG['duree_pwd'] > 0){
    if (isEngraisChimiques()) {
        if (isFusion()){
            $liste_champ = array("login", "profil", "pwd_non_expire", "have_left_frame", "billet_req", "langue", "is_agent_ec","n_agence");
            $ordre_champ = array("profil", "login", "pwd1", "pwd2", "pwd_non_expire", "have_left_frame", "billet_req", "uti", "langue", "is_agent_ec", "guic","n_agence");
        }else{
        ...
        if(isFusion()){
            $liste_champ = array("login", "profil", "pwd_non_expire", "have_left_frame", "billet_req", "langue","n_agence");
            $ordre_champ = array("profil", "login", "pwd1", "pwd2", "pwd_non_expire", "have_left_frame", "billet_req", "uti", "langue", "guic","n_agence");
        }else{
    ...
    if (isEngraisChimiques()) {
        if(isFusion()){
            $liste_champ = array("login", "profil", "have_left_frame", "billet_req", "langue", "is_agent_ec","n_agence");
            $ordre_champ = array("profil", "login", "pwd1", "pwd2", "have_left_frame", "billet_req", "uti", "langue", "is_agent_ec", "guic","n_agence");
        }else{
        ...
        if (isFusion()){
            $liste_champ = array("login", "profil", "have_left_frame", "billet_req", "langue","n_agence");
            $ordre_champ = array("profil", "login", "pwd1", "pwd2", "have_left_frame", "billet_req", "uti", "langue",  "guic","n_agence");
        }else{
  ...
  if($AG['plafond_retrait_guichet'] == 't' && $AG['plafond_depot_guichet'] == 't'){
    if (isEngraisChimiques()) {
      if (isFusion()){
          $liste_champ = array("login", "profil", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_retrait", "depasse_plafond_depot", "langue", "is_agent_ec","n_agence");
          $ordre_champ = array("profil", "login", "pwd1", "pwd2", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_retrait", "depasse_plafond_depot", "uti", "langue", "is_agent_ec", "guic","n_agence");
      }else{
        ...
        if(isFusion()){
            $liste_champ = array("login", "profil", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_retrait", "depasse_plafond_depot", "langue","n_agence");
            $ordre_champ = array("profil", "login", "pwd1", "pwd2", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_retrait", "depasse_plafond_depot", "uti", "langue", "guic","n_agence");
        }else{
    ...
    if (isEngraisChimiques()) {
        if (isFusion()){
            $liste_champ = array("login", "profil", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_retrait", "langue", "is_agent_ec","n_agence");
            $ordre_champ = array("profil", "login", "pwd1", "pwd2", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_retrait", "uti", "langue", "is_agent_ec", "guic","n_agence");
        }else{
      ...
      if (isEngraisChimiques()) {
          if(isFusion()){
              $liste_champ = array("login", "profil", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_retrait", "langue","n_agence");
              $ordre_champ = array("profil", "login", "pwd1", "pwd2", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_retrait", "uti", "langue", "guic","n_agence");
          }else{
    ...
    if (isEngraisChimiques()) {
        if(isFusion()){
            $liste_champ = array("login", "profil", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_depot", "langue", "is_agent_ec","n_agence");
            $ordre_champ = array("profil", "login", "pwd1", "pwd2", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_depot", "uti", "langue", "is_agent_ec", "guic","n_agence");
        }else{
        ...
        if(isFusion()){
            $liste_champ = array("login", "profil", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_depot", "langue","n_agence");
            $ordre_champ = array("profil", "login", "pwd1", "pwd2", "pwd_non_expire", "have_left_frame", "billet_req", "depasse_plafond_depot", "uti", "langue",  "guic","n_agence");
        }else{
  ...
  /********************************************************/
  if(isFusion()) {
      $n_agence = $info["n_agence"];
      $n_guichet = $info["n_guichet"];
      ...
      //$MyPage->setFieldProperties("province", FIELDP_HAS_CHOICE_TOUS, false);
      // $MyPage->setFieldProperties("province", FIELDP_HAS_CHOICE_AUCUN, true);
      $MyPage->setFieldProperties("n_agence", FIELDP_INCLUDE_CHOICES, $includeChoicesFenacobu);;
      $MyPage->setFieldProperties("n_agence", FIELDP_IS_REQUIRED, true);
      $MyPage->setFieldProperties("n_agence", FIELDP_DEFAULT, $info['n_agence']);
      ...
      if (isset($n_agence) && isset($n_guichet)) { //AT-150 page reloaded take value from posted data
          $choices = array();
          reset($nivArrayFenacobu);
          ...
          $MyPage->setFieldProperties("n_guichet", FIELDP_DEFAULT, $info['n_guichet']);
      } else {
          $MyPage->setFieldProperties("n_guichet", FIELDP_ADD_CHOICES, array(
              "0" => "[Aucun]"
          ));
      }
  ...
  if($AG['duree_pwd']>0){ // verifier si on definit la durée de mot de passe, alors mettre le champs pwd_non_expire
    if (isEngraisChimiques()) {
      ...
      $liste_champ_ord = array("idu", "nome", "login", "profil", "langue", "pwd1", "pwd2", "pwd_non_expire", "is_agent_ec");
        ...
        $liste_champ = array("login", "profil", "pwd_non_expire", "have_left_frame", "billet_req", "langue", "n_agence");
        $liste_champ_ord = array("idu", "nome", "login", "profil", "langue", "pwd1", "pwd2", "pwd_non_expire", "n_agence");
    }else{
      $liste_champ = array("login", "profil", "pwd_non_expire", "have_left_frame", "billet_req", "langue");
  ...
  // ajout des champs de niveau de l'agence ------------------------------------------------------------------------------------------
    if (isFusion()) {
        $nivArrayFenacobu = getNivFenacobuArray("type_niveau > 1");
        // --> Sélection des champs à afficher dans id_loc
        reset($nivArrayFenacobu);
        ...
        while (list (, $value_fenacobu) = each($nivArrayFenacobu)) {
            if ($value_fenacobu['parent'] != '') {
                $jsCodeNivFenacobu .= "\tif (document.ADForm.HTML_GEN_LSB_n_agence.value == " . $value_fenacobu['parent'] . ")\n";
                $jsCodeNivFenacobu .= "\t\tdocument.ADForm.HTML_GEN_LSB_n_guichet.options[document.ADForm.HTML_GEN_LSB_n_guichet.length] = new Option('" . $value_fenacobu['libelle_localisation'] . "', '" . $value_fenacobu['id'] . "', false, false);\n";
            }
        }
        $jsCodeNivFenacobu .= "\n}";
        // --> Ajout de la fonction dans le formulaire
        ...
        if (isset($n_agence) && isset($n_guichet)) { //AT-150 page reloaded take value from posted data
            ...
            $MyPage->setFieldProperties("n_guichet", FIELDP_HAS_CHOICE_AUCUN, true);
        } else {
            $MyPage->setFieldProperties("n_guichet", FIELDP_ADD_CHOICES, array(
                "0" => "[Aucun]"
            ));
  ...
  //Ordre
    if (isFusion()){
        $MyPage->setOrder(NULL, array("idu", "nome", "login", "profil", "langue","pwd1", "pwd2","n_agence","n_guichet"));
    }else{
