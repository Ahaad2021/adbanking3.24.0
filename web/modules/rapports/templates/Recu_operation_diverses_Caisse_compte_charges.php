...
<?php if($format == 'A4'){ ?>
<title>Recu_operation_diverses_Caisse_compte_charges_A4</title>
<?php }else if($format == 'A6'){ ?>
<title>Recu_operation_diverses_Caisse_compte_charges_A6</title>
<?php }else if($format == 'CT'){ ?>
<title>Recu_operation_diverses_Caisse_compte_charges_CT</title>
<?php }else if($format == 'JALI'){ ?>
<title>Recu_operation_diverses_Caisse_compte_charges_JALI</title>
<?php }else if($format == 'TWG'){ ?>
<title>Recu_operation_diverses_Caisse_compte_charges_TWG</title>
<?php }else if($format == 'DTB'){ ?>
<title>Recu_operation_diverses_Caisse_compte_charges_DTB</title>
<?php }else{ ?>
<title>Recu_operation_diverses_Caisse_compte_charges</title>
<?php } 
if($format != 'TWG'){
  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    ...
    <tr>
        <td align="center" colspan="4">
            <h3 style="margin-block-start: 0em;text-align: center;<?php echo $margin_bt?>"  class="<?php echo $header_institution ?>">Reçu opération diverse de caisse</h3>
        </td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Date opération</td>
        <td colspan="2">: <?php echo $xml->body->date_op;?></td>
        <td colspan="1">&nbsp;</td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Libellé opération</td>
        <td colspan="2">: <?php echo $xml->body->libelle_op;?></td>
        <td colspan="1">&nbsp;</td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Compte débit</td>
        <td colspan="1">: <?php echo $xml->body->compte_debit;?></td>
        <td colspan="1"> Compte crédit</td>
        <td colspan="1">: <?php echo $xml->body->compte_credit;?></td>
    </tr>
    <tr>
        <td align="center"  class="<?php echo $heder_detail; ?>" colspan="4">
            <table width="100%" style="border: 1px dashed #cccccc;border-collapse: collapse;" class="<?php echo $table_margin;?>">
                <tbody>
                    <tr class="<?php echo $heder_detail; ?>">
                        <td style="border: 1px dashed #cccccc;padding-left: 5px">
                            <table>
                                <tbody>
                                    <tr  class="<?php echo $heder_detail; ?>">
                                        <td colspan="1">Devise débit</td>
                                        <td colspan="1">: <?php echo $xml->body->devise_debit;?></td>
                                    </tr>
                                    <tr  class="<?php echo $heder_detail; ?>">
                                        <td colspan="1">Montant débit</td>
                                        <td colspan="1">: <?php echo $xml->body->montant_debit;?></td>
                                    </tr>
                                    <tr  class="<?php echo $heder_detail; ?>">
                                        <td colspan="1">Montant tva</td>
                                        <td colspan="1">: <?php echo $xml->body->montant_tax_debit;?></td>
                                    </tr>
                                    <tr  class="<?php echo $heder_detail; ?>">
                                        <td colspan="1">Montant ttc</td>
                                        <td colspan="1">: <?php echo $xml->body->montant_ttc_debit;?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                        <td style="border: 1px dashed #cccccc;padding-left: 5px">
                            <table>
                                <tbody>
                                    <tr  class="<?php echo $heder_detail; ?>">
                                        <td colspan="1">Devise crédit</td>
                                        <td colspan="1">: <?php echo $xml->body->devise_credit;?></td>
                                    </tr>
                                    <tr  class="<?php echo $heder_detail; ?>">
                                        <td colspan="1">Montant crédit</td>
                                        <td colspan="1">: <?php echo $xml->body->montant_credit;?></td>
                                    </tr>
                                    <tr  class="<?php echo $heder_detail; ?>">
                                        <td colspan="1">Montant tva</td>
                                        <td colspan="1">: <?php echo $xml->body->montant_tax_credit;?></td>
                                    </tr>
                                    <tr  class="<?php echo $heder_detail; ?>">
                                        <td colspan="1">Montant ttc</td>
                                        <td colspan="1">: <?php echo $xml->body->montant_ttc_credit;?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
    ...
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Type pièce</td>
        <td colspan="2">: <?php echo $xml->body->type_piece;?></td>
        <td colspan="1">&nbsp;</td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Numéro pièce</td>
        <td colspan="2">: <?php echo $xml->body->numero_piece;?></td>
        <td colspan="1">&nbsp;</td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Date pièce</td>
        <td colspan="2">: <?php echo $xml->body->date_piece;?></td>
        <td colspan="1">&nbsp;</td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Communication</td>
        <td colspan="2">: <?php echo $xml->body->communication;?></td>
        <td colspan="1">&nbsp;</td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Remarque</td>
        <td colspan="2">: <?php echo $xml->body->remarque;?></td>
        <td colspan="1">&nbsp;</td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Numéro de transaction</td>
        <td colspan="2">: <?php echo $xml->body->num_trans;?></td>
        <td colspan="1">&nbsp;</td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
