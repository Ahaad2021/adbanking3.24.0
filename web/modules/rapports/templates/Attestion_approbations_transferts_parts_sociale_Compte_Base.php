...
<?php if($format == 'A4'){ ?>
<title>Attestion_approbation_transferts_parts_sociale_compte_partsociale_A4</title>
<?php }else if($format == 'A6'){ ?>
<title>Attestion_approbation_transferts_parts_sociale_compte_partsociale_A6</title>
<?php }else if($format == 'CT'){ ?>
<title>Attestion_approbation_transferts_parts_sociale_compte_partsociale_CT</title>
<?php }else if($format == 'JALI'){ ?>
<title>Attestion_approbation_transferts_parts_sociale_compte_partsociale_JALI</title>
<?php }else if($format == 'TWG'){ ?>
<title>Attestion_approbation_transferts_parts_sociale_compte_partsociale_TWG</title>
<?php }else if($format == 'DTB'){ ?>
<title>Attestion_approbation_transferts_parts_sociale_compte_partsociale_DTB</title>
<?php }else{ ?>
<title>Attestion_approbation_transferts_parts_sociale_compte_partsociale</title>
<?php } 
if($format != 'TWG'){
  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    ...
    <tr>
        <td align="center" colspan="2">
            <h3 style="margin-block-start: 0em;text-align: center;<?php echo $margin_bt?>"  class="<?php echo $header_institution ?>">Attestation de transfert parts sociales<br>Transfert vers compte courant</h3>
        </td>
    </tr>
    ...
    <tr class="<?php echo $heder_detail; ?>">
        ...
        <td style="width: 50%">Intitulé du compte: <?php echo $xml->body->libelle_courant;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 50%">Nom: <?php echo $xml->body->nom_client;?></td>
        <td style="width: 50%">Numero du compte courant: <?php echo $xml->body->num_compte_dest;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 50%">Numéro compte de part sociales: <?php echo $xml->body->num_cpte_ps;?></td>
        <td style="width: 50%">Nouveau solde du compte: <?php echo $xml->body->solde_courant;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
