...
if($format == 'A4'){
 ...
 ?>
  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    ...
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Montant retrait</td>
        <td style="width: 35%">: <?php echo $xml->body->montant_retrait;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Date de demande</td>
        <td style="width: 35%">: <?php echo $xml->body->date_demande;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Utilisateur</td>
        <td style="width: 35%">: <?php echo $xml->body->utilisateur_demande;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Numéro de transaction</td>
        <td style="width: 35%">: <?php echo $xml->body->num_transaction;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
