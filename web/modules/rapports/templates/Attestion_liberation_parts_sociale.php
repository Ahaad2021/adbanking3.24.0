...
<?php if($format == 'A4'){ ?>
<title>Attestion_liberation_parts_sociale_A4</title>
<?php }else if($format == 'A6'){ ?>
<title>Attestion_liberation_parts_sociale_A6</title>
<?php }else if($format == 'CT'){ ?>
<title>Attestion_liberation_parts_sociale_CT</title>
<?php }else if($format == 'JALI'){ ?>
<title>Attestion_liberation_parts_sociale_JALI</title>
<?php }else if($format == 'TWG'){ ?>
<title>Attestion_liberation_parts_sociale_TWG</title>
<?php }else if($format == 'DTB'){ ?>
<title>Attestion_liberation_parts_sociale_DTB</title>
<?php }else{ ?>
<title>Attestion_liberation_parts_sociale</title>
<?php } 
if($format != 'TWG'){
  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    ...
    <tr>
        <td align="center" colspan="2">
            <h3 style="margin-block-start: 0em;text-align: center;<?php echo $margin_bt?>"  class="<?php echo $header_institution ?>">Attestation de libération des parts sociales</h3>
        </td>
    </tr>
    ...
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Numéro du compte de parts sociales</td>
        <td style="width: 35%">: <?php echo $xml->body->num_cpte_ps;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
    ...
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Nouvelles parts sociales libérées</td>
        <td style="width: 35%">: <?php echo $xml->body->nbre_parts_lib;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Nombre total de parts sociales souscrites</td>
        <td style="width: 35%">: <?php echo $xml->body->nbre_total_ps;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Nombre total de parts sociales libérées</td>
        <td style="width: 35%">: <?php echo $xml->body->nbre_parts_lib;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Montant libérén</td>
        <td style="width: 35%">: <?php echo $xml->body->solde_cpte_ps;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Montant restant à libéré</td>
