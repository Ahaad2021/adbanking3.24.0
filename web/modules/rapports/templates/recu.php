...
<?php if($format == 'A4'){ ?>
<title>Recu_Retrait_A4</title>
<?php }else if($format == 'A6'){ ?>
<title>Recu_Retrait_A6</title>
<?php }else if($format == 'CT'){ ?>
<title>Recu_Retrait_CT</title>
<?php }else if($format == 'JALI'){ ?>
<title>Recu_Retrait_JALI</title>
<?php }else if($format == 'TWG'){ ?>
<title>Recu_Retrait_TWG</title>
<?php }else if($format == 'DTB'){ ?>
<title>Recu_Retrait_DTB</title>
<?php }else{ ?>
  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    ...
    <tr>
        <td align="center" colspan="2">
            <h3 style="margin-block-start: 0em;text-align: center;<?php echo $margin_bt?>"  class="<?php echo $header_institution ?>">Reçu retrait en espèces</h3>
        </td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Nom du client</td>
        <td style="width: 35%">: <?php echo $xml->body->nom_client;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Numéro de compte</td>
        <td style="width: 35%">: <?php echo $xml->body->num_cpte;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Montant</td>
        <td style="width: 35%">: <?php echo $xml->body->montant;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Montant en lettre</td>
        <td style="width: 35%">: <?php echo $xml->body->mntEnLettre;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Frais de retrait/dépôt</td>
        <td style="width: 35%">: <?php echo $xml->body->frais;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Frais de non respect de la duree minimum entre deux retraits</td>
        <td style="width: 35%">: <?php echo $xml->body->fraisDureeMin;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Nouveau solde</td>
        <td style="width: 35%">: <?php echo $xml->body->solde;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Numéro de transaction</td>
        <td style="width: 35%">: <?php echo $xml->body->num_trans;?></td>
    </tr>
    <tr>
            ...
            <table width="100%" style="border: 1px dashed #cccccc;border-collapse: collapse;" class="<?php echo $table_margin;?>">
                <tbody>
                    <tr class="<?php echo $heder_detail; ?>">
                        ...
                        <?php
                        for ($i = 0; $i < 14; $i++) {
                            $libel_billet = htmlspecialchars($xml->body->{'libel_billet_' . $i});
                            if($libel_billet != ''){
                    ...
                    <tr class="<?php echo $heder_detail; ?>">
                        ...
                        <?php
                        for ($i = 0; $i < 14; $i++) {
                            $valeur_billet = $xml->body->{'valeur_billet_' . $i};
                            if($valeur_billet != ''){
                    ...
                    <tr class="<?php echo $heder_detail; ?>">
                        ...
                        <?php
                        for ($i = 0; $i < 14; $i++) {
                            $total_billet = $xml->body->{'total_billet_' . $i};
                            if($total_billet != ''){
