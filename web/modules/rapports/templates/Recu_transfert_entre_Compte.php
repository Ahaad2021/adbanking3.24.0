...
<?php if($format == 'A4'){ ?>
<title>Recu_transfert_entre_Compte_A4</title>
<?php }else if($format == 'A6'){ ?>
<title>Recu_transfert_entre_Compte_A6</title>
<?php }else if($format == 'CT'){ ?>
<title>Recu_transfert_entre_Compte_CT</title>
<?php }else if($format == 'JALI'){ ?>
<title>Recu_transfert_entre_Compte_JALI</title>
<?php }else if($format == 'TWG'){ ?>
<title>Recu_transfert_entre_Compte_TWG</title>
<?php }else if($format == 'DTB'){ ?>
<title>Recu_transfert_entre_Compte_DTB</title>
<?php }else{ ?>
<title>Recu_transfert_entre_Compte</title>
<?php } 
if($format != 'TWG'){
  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    <tr>
        <td align="left" colspan="2">
            <h3 style="margin-block-start: 0em;<?php echo $margin;?>" class="<?php echo $header_institution ?>"><?php echo $xml->body->header->institution; ?></h3>
            <p class="<?php echo $heder_detail; ?>" style="<?php echo $padding.' '.$margin;?>">
                Agency    : <?php echo $xml->body->header->agence;?>
                <br>
                Phone     : <?php echo $xml->body->header->telephone;?>
                <br>
                Opérateur : <?php echo $xml->body->header->utilisateur;?>
            </p>
        </td>
        ...
        <td align="right" colspan="2">
            ...
            <p class="<?php echo $heder_detail; ?>" style="<?php echo $margin_zero;?>">
                Time Stamp: <?php echo $xml->body->header->date." ".$xml->body->header->heure;?>
            </p>
        </td>
    </tr>
    ...
    <tr>
        <td align="center" colspan="4">
            <h3 style="margin-block-start: 0em;text-align: center;<?php echo $margin_bt?>"  class="<?php echo $header_institution ?>">Reçu Transfert entre compte</h3>
        </td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Nom du client</td>
        <td colspan="2">: <?php echo $xml->body->donneur->nomClient;?></td>
        <td colspan="1">&nbsp;</td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Montant virement</td>
        <td colspan="1">: <?php echo $xml->body->donneur->montant;?></td>
        <td colspan="1">Numéro de compte</td>
        <td colspan="1">: <?php echo $xml->body->donneur->numCpte;?></td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Frais</td>
        <td colspan="1">: <?php echo $xml->body->transfert->frais;?></td>
        <td colspan="1">&nbsp;</td>
        <td colspan="1">&nbsp;</td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td colspan="1">Date de transaction</td>
        <td colspan="1">: <?php echo $xml->body->transfert->dateTransa;?></td>
        <td colspan="1"> Numéro de transaction</td>
        <td colspan="1">: <?php echo $xml->body->transfert->numTransa;?></td>
    </tr>
    <tr>
        <td align="center"  class="<?php echo $heder_detail; ?>" colspan="4">
            <table width="100%" style="border: 1px dashed #cccccc;border-collapse: collapse;" class="<?php echo $table_margin;?>">
                <tbody>
                    ...
                    ?>
                    <tr class="<?php echo $heder_detail; ?>">
                        <td style="border: 1px dashed #cccccc;padding-left: 5px">Bénéficiaire</td>
                        <td style="border: 1px dashed #cccccc;padding-left: 5px">Numéro de compte</td>
                        <td style="border: 1px dashed #cccccc;padding-left: 5px">date de demande</td>
                        <td style="border: 1px dashed #cccccc;padding-left: 5px">Montant prélevé</td>
                        <td style="border: 1px dashed #cccccc;padding-left: 5px">Montant transféré</td>
                    </tr>
                    <tr class="<?php echo $heder_detail; ?>">
                        <td style="border: 1px dashed #cccccc;padding-left: 5px"><?php echo $xml->body->beneficaires->nomBeneficaire;?></td>
                        <td style="border: 1px dashed #cccccc;padding-left: 5px;<?php echo $nowrap;?>"><?php echo $xml->body->beneficaires->numCpteBeneficaire;?></td>
                        <td style="border: 1px dashed #cccccc;padding-left: 5px"><?php echo $xml->body->beneficaires->dateDemandeVir;?></td>
                        <td style="border: 1px dashed #cccccc;padding-left: 5px"><?php echo str_replace(' ', '', $xml->body->beneficaires->mntPreleve)?></td>
                        <td style="border: 1px dashed #cccccc;padding-left: 5px"><?php echo str_replace(' ', '', $xml->body->beneficaires->mntBeneficaire)?></td>
                    </tr>
                </tbody>
            </table>
        </td>
    ...
    <tr class="<?php echo $heder_detail; ?>">
        <td  colspan="2" style="padding-left: 5px;"><div style="margin-left:20px;margin-right:20px;">Signature opérateur</div></td>
        <td  colspan="2" style="padding-left: 5px;"><div style="margin-left:20px;margin-right:20px;">Signature client</div></td>
    </tr>          
    <tr>
