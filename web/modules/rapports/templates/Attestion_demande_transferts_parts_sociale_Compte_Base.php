...
<?php if($format == 'A4'){ ?>
<title>Attestion_demande_transferts_parts_sociale_Compte_Base_A4</title>
<?php }else if($format == 'A6'){ ?>
<title>Attestion_demande_transferts_parts_sociale_Compte_Base_A6</title>
<?php }else if($format == 'CT'){ ?>
<title>Attestion_demande_transferts_parts_sociale_Compte_Base_CT</title>
<?php }else if($format == 'JALI'){ ?>
<title>Attestion_demande_transferts_parts_sociale_Compte_Base_JALI</title>
<?php }else if($format == 'TWG'){ ?>
<title>Attestion_demande_transferts_parts_sociale_Compte_Base_TWG</title>
<?php }else if($format == 'DTB'){ ?>
<title>Attestion_demande_transferts_parts_sociale_Compte_Base_DTB</title>
<?php }else{ ?>
<title>Attestion_demande_transferts_parts_sociale_Compte_Base</title>
<?php } 
if($format != 'TWG'){
  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    ...
    <tr>
        <td align="center" colspan="2">
            <h3 style="margin-block-start: 0em;text-align: center;<?php echo $margin_bt?>"  class="<?php echo $header_institution ?>">Attestation de demande de transfert parts sociales<br>Transfert vers compte courant</h3>
        </td>
    </tr>
