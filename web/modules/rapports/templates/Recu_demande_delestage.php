...
<?php if($format == 'A4'){ ?>
<title>Recu_demande_delestage_A4</title>
<?php }else if($format == 'A6'){ ?>
<title>Recu_demande_delestage_A6</title>
<?php }else if($format == 'CT'){ ?>
<title>Recu_demande_delestage_CT</title>
<?php }else if($format == 'JALI'){ ?>
<title>Recu_demande_delestage_JALI</title>
<?php }else if($format == 'TWG'){ ?>
<title>Recu_demande_delestage_TWG</title>
<?php }else if($format == 'DTB'){ ?>
<title>Recu_demande_delestage_DTB</title>
<?php }else{ ?>
<title>Recu_demande_delestage</title>
<?php } 
if($format != 'TWG'){
  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    ...
    <tr>
        <td align="center" colspan="2">
            <h3 style="margin-block-start: 0em;text-align: center;<?php echo $margin_bt?>"  class="<?php echo $header_institution ?>">Reçu demande délestage</h3>
        </td>
    </tr>
    ...
    <tr class="<?php echo $heder_detail; ?>">
        ...
        <td style="width: 35%">: <?php echo $xml->body->fraisDureeMin;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
