...
<?php if($format == 'A4'){ ?>
<title>Recu_Depot_A4</title>
<?php }else if($format == 'A6'){ ?>
<title>Recu_Depot_A6</title>
<?php }else if($format == 'CT'){ ?>
<title>Recu_Depot_CT</title>
<?php }else if($format == 'JALI'){ ?>
<title>Recu_Depot_JALI</title>
<?php }else if($format == 'TWG'){ ?>
<title>Recu_Depot_TWG</title>
<?php }else if($format == 'DTB'){ ?>
<title>Recu_Depot_DTB</title>
<?php }else{ ?>
<title>Recu_Depot</title>
<?php } 
if($format != 'TWG'){
  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    ...
    <tr>
        <td align="center" colspan="2">
            <h3 style="margin-block-start: 0em;text-align: center;<?php echo $margin_bt?>"  class="<?php echo $header_institution ?>">Reçu dépôt en espèces</h3>
        </td>
    </tr>
    ...
    <?php if($xml->body->frais_attente != ''){
        ?>
        <tr class="<?php echo $heder_detail; ?>">
            <td style="width: 70%">Frais en attente</td>
            <td style="width: 35%">: <?php echo $xml->body->frais_attente;?></td>
        </tr>
    <?php } ?>
    <tr class="<?php echo $heder_detail; ?>">
