...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
    <xsl:template match="/">
        <fo:root>
            ...
            <xsl:apply-templates select="recu_agent"/>
        </fo:root>
    </xsl:template>
    ...
    <xsl:template match="body">
        <fo:list-block>
            ...
            <fo:list-item>
                ...
                <fo:list-item-body>
                    <fo:block space-before.optimum="0.3cm">Montant : <xsl:value-of select="montant"/><xsl:if test="/recu_agent/@type='7'"><fo:inline font-weight="bold">  (sous réserve d'encaissement)</fo:inline></xsl:if></fo:block>
                </fo:list-item-body>
            </fo:list-item>
            ...
            <xsl:if test="/recu_agent/@type='6' or /recu_agent/@type='8' or /recu_agent/@type='40'">
                <xsl:if test="frais">
                    <fo:list-item>
                        <fo:list-item-label>
                            <fo:block/>
                ...
                <xsl:if test="commission_transaction">
                    <fo:list-item>
                        <fo:list-item-label>
                            <fo:block/>
                        </fo:list-item-label>
                        <fo:list-item-body>
                            <fo:block space-before.optimum="0.3cm">Commission sur transaction via agent : <xsl:value-of select="commission_transaction"/></fo:block>
                        </fo:list-item-body>
                    </fo:list-item>
                </xsl:if>
                <xsl:if test="solde">
            ...
            <xsl:if test="/recu_agent/@type='7' or /recu_agent/@type='40'">
