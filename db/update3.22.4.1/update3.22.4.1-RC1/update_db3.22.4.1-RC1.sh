...
if [[ "$TEST" >0 ]]; then
    ...
    execute_psql 0 /usr/share/adbanking/db/update3.22.4.1/update3.22.4.1-RC1/updata3.22.4.1-RC1.sql
    chmod 777 -R /usr/share/adbanking/web/services/mobile_lending/

else
    source /usr/share/adbanking/db/update3.22.4.1/update3.22.4.1-RC1/update_db3.22.4.1-RC1.sh $1
fi