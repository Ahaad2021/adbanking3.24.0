...
if [[ "$TEST" >0 ]]; then
    ...
    execute_psql 0 /usr/share/adbanking/db/update3.22.4.5/update3.22.4.5-RC2/updata3.22.4.5-RC2.sql
    chmod 777 -R /usr/share/adbanking/web/services/mobile_lending/

else
    source /usr/share/adbanking/db/update3.22.4.5/update3.22.4.5-RC2/update_db3.22.4.5-RC2.sh $1
fi