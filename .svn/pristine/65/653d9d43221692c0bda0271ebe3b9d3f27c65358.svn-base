  ...
  if ($global_nom_ecran == "Acl-2") {
    ...
    if($data_agc['identification_client'] == 2){
      ...
      if (isFusion()){
          ...
          array_push($exclude, "id_cpte_base", "date_rupt", "dern_modif", "utilis_modif", "utilis_crea", "gestionnaire", "nbre_credits", "classe","id_loc2","province","district","secteur","cellule","village","classe_socio_economique","n_agence","n_guichet");
      }
    ...
    if($data_agc["is_zone_required"] == 't'){
    ...
    if ($SESSION_VARS['statut_juridique'] == 1) { // Personne physique
      ...
      if($data_agc['identification_client'] == 2){
        array_push($Order, "adresse", "code_postal", "ville", "pays", "num_tel", "num_fax", "num_port", "email","province","district","secteur","cellule","village", "client_zone", "education" ,"classe_socio_economique");
          ...
          array_push($Order, "adresse", "code_postal", "ville", "pays", "num_tel", "num_fax", "num_port", "email", "id_loc1", "id_loc2", "loc3", "client_zone","n_agence","n_guichet");
      }
      else{
      ...
      if ($SESSION_VARS['statut_juridique'] == 2) { // Personne morale
        ...
        if($data_agc['identification_client'] == 2){
          array_push($Order, "pm_raison_sociale", "pm_abreviation", "adresse", "code_postal", "ville", "pays", "num_tel", "pm_tel2", "pm_tel3", "num_fax", "num_port", "email", "pm_email2", "province","district","secteur","cellule","village", "client_zone");
            ...
            array_push($Order, "pm_raison_sociale", "pm_abreviation", "adresse", "code_postal", "ville", "pays", "num_tel", "pm_tel2", "pm_tel3", "num_fax", "num_port", "email", "pm_email2", "id_loc1", "id_loc2", "loc3", "client_zone","n_agence","n_guichet");
        }
        else{
	...
	array_push($Order, "pm_categorie", "pm_nature_juridique", "sect_act", "pp_pm_activite_prof", "pp_pm_patrimoine", "nb_imf", "nb_bk", "nbre_hommes_grp", "nbre_femmes_grp", "pm_date_notaire", "pm_date_depot_greffe", "pm_lieu_depot_greffe", "pm_date_expiration", "pm_numero_reg_nat", "pm_numero_nric", "pm_lieu_nric", "pm_date_constitution", "pm_agrement_nature", "pm_agrement_autorite", "pm_agrement_numero", "pm_agrement_date", "etat");
        ...
        if ($SESSION_VARS['statut_juridique'] == 3) { // Groupe informel
          ...
          // Ordre d'affichage
          if($data_agc['identification_client'] == 2){
            array_push($Order, "gi_nom", "adresse", "code_postal", "ville", "pays", "num_tel", "num_fax", "num_port", "email", "province","district","secteur","cellule","village","client_zone", "sect_act", "langue", "gi_nbre_membr", "nbre_hommes_grp", "nbre_femmes_grp", "nb_imf", "nb_bk", "gi_date_agre", "etat");
          }
          else if (isFusion()){
              array_push($Order, "gi_nom", "adresse", "code_postal", "ville", "pays", "num_tel", "num_fax", "num_port", "email", "id_loc1", "id_loc2", "loc3", "client_zone", "sect_act", "langue", "gi_nbre_membr", "nbre_hommes_grp", "nbre_femmes_grp", "nb_imf", "nb_bk", "gi_date_agre", "etat","n_agence","n_guichet");
          }
          else{
            array_push($Order, "gi_nom", "adresse", "code_postal", "ville", "pays", "num_tel", "num_fax", "num_port", "email", "id_loc1", "id_loc2", "loc3", "client_zone", "sect_act", "langue", "gi_nbre_membr", "nbre_hommes_grp", "nbre_femmes_grp", "nb_imf", "nb_bk", "gi_date_agre", "etat");
          }        
	} else
          if ($SESSION_VARS['statut_juridique'] == 4) { // Groupe solidaire
            ...
            // Ordre d'affichage
            if($data_agc['identification_client'] == 2){
              array_push($Order, "gi_nom", "gs_responsable", "adresse", "code_postal", "ville", "pays", "num_tel", "num_fax", "num_port", "email", "province","district","secteur","cellule","village", "province","district","secteur","cellule","village", "client_zone",  "sect_act", "langue", "nb_imf", "nb_bk", "etat");
            }
            else if (isFusion()){
                array_push($Order, "gi_nom", "gs_responsable", "adresse", "code_postal", "ville", "pays", "num_tel", "num_fax", "num_port", "email", "id_loc1", "id_loc2", "loc3", "client_zone", "sect_act", "langue", "nb_imf", "nb_bk", "etat","n_agence","n_guichet");
            }
            else{
              array_push($Order, "gi_nom", "gs_responsable", "adresse", "code_postal", "ville", "pays", "num_tel", "num_fax", "num_port", "email", "id_loc1", "id_loc2", "loc3", "client_zone", "sect_act", "langue", "nb_imf", "nb_bk", "etat");
            }          
	  }
...
/***************************************************************************************************************************/
    ...
    if ( $CLI["statut_juridique"] == 1) {       // Personne physique
      ...
      array_push($Order, "province","district","secteur","cellule","village");
        if (isFusion()){
            array_push($Order,"n_agence","n_guichet");
        }
    }
    // Mise en ordre
