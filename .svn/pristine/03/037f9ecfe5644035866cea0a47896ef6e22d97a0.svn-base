    ...
    <xsl:template match="body">
        <fo:list-block>
            ...
            <fo:list-item>
                ...
                <fo:list-item-body>
                    <fo:block space-before.optimum="0.3cm">Montant : <xsl:value-of select="montant"/></fo:block>
                </fo:list-item-body>
            </fo:list-item>
            <!--<xsl:if test="/recu/@type='6' or /recu/@type='8' or /recu/@type='40'">-->
                <xsl:if test="comm_transaction">
                    <fo:list-item>
                        <fo:list-item-label>
                            <fo:block/>
                        </fo:list-item-label>
                        <fo:list-item-body>
                            <fo:block space-before.optimum="0.3cm">Commission sur transaction via agent: <xsl:value-of select="comm_transaction"/></fo:block>
                        </fo:list-item-body>
                    </fo:list-item>
                </xsl:if>
