  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    ...
    <tr>
        <td align="center" colspan="2">
            <h3 style="margin-block-start: 0em;text-align: center;<?php echo $margin_bt?>"  class="<?php echo $header_institution ?>">Reçu délestage</h3>
        </td>
    </tr>
    ...
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Compte coffre-fort débité</td>
        <td style="width: 35%">: <?php echo $xml->compte_debit->compte_coffre_debit;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Compte caisse crédité</td>
    ...
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Montant délesté </td>
