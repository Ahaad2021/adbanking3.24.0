<?php
    ...
    if (sizeof($dcr_encours) > 0){
        ...
        if ($donnees_client_abonnees['score_final'] >= 0 && $donnees_client_abonnees['score_final'] < 60) {
            $status_dossier = 'rejet';
        } else if ($donnees_client_abonnees['score_final'] >= 60 && $donnees_client_abonnees['score_final'] < 80) {
            $status_dossier = 'attente';
        } else if ($donnees_client_abonnees['score_final'] >= 80) {
