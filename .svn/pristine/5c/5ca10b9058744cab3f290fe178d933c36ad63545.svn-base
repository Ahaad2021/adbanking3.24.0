...
<?php if($format == 'A4'){ ?>
<title>Recu_de_perception_versement_initiale_A4</title>
<?php }else if($format == 'A6'){ ?>
<title>Recu_de_perception_versement_initiale_A6</title>
<?php }else if($format == 'CT'){ ?>
<title>Recu_de_perception_versement_initiale_CT</title>
<?php }else if($format == 'JALI'){ ?>
<title>Recu_de_perception_versement_initiale_JALI</title>
<?php }else if($format == 'TWG'){ ?>
<title>Recu_de_perception_versement_initiale_TWG</title>
<?php }else if($format == 'DTB'){ ?>
<title>Recu_de_perception_versement_initiale_DTB</title>
<?php }else{ ?>
<title>Recu_de_perception_versement_initiale</title>
<?php } 
if($format != 'TWG'){
  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    ...
    <tr>
        <td align="center" colspan="2">
            <h3 style="margin-block-start: 0em;text-align: center;<?php echo $margin_bt?>"  class="<?php echo $header_institution ?>">Reçu de perception du versement initial</h3>
        </td>
    </tr>
    <tr  class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Numéro de client</td>
        <td style="width: 35%">: <?php echo $xml->body->num_client;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Nom</td>
        <td style="width: 35%">: <?php echo $xml->body->nom_client;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Montant des frais d'adhésion</td>
        <td style="width: 35%">: <?php echo $xml->body->montant_frais_adh;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Montant frais d'adhésion versé</td>
        <td style="width: 35%">: <?php echo $xml->body->tranche_frais;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Nombre de parts sociales souscrites</td>
        <td style="width: 35%">: <?php echo $xml->body->nbre_parts;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Nombre de parts sociales libérées</td>
        <td style="width: 35%">: <?php echo $xml->body->nbre_parts_lib;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Valeur nominale d'une part sociale</td>
        <td style="width: 35%">: <?php echo $xml->body->prix_part;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Montant de la Libération part sociale</td>
        <td style="width: 35%">: <?php echo $xml->body->total_ps;?></td>
    </tr>  
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Montant total versé</td>
        <td style="width: 35%">: <?php echo $xml->body->total;?></td>
    </tr>  
    <tr class="<?php echo $heder_detail; ?>">
    ...
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Solde du compte de base</td>
        <td style="width: 35%">: <?php echo $xml->body->solde_cpt_base;?></td>
    </tr>  
    <tr class="<?php echo $heder_detail; ?>">
