...
<?php if($format == 'A4'){ ?>
<title>Demande d'autorisation_retrait_A4</title>
<?php }else if($format == 'A6'){ ?>
<title>Demande d'autorisation_retrait_A6</title>
<?php }else if($format == 'CT'){ ?>
<title>Demande d'autorisation_retrait_CT</title>
<?php }else if($format == 'JALI'){ ?>
<title>Demande d'autorisation_retrait_JALI</title>
<?php }else if($format == 'TWG'){ ?>
<title>Demande d'autorisation_retrait_TWG</title>
<?php }else if($format == 'DTB'){ ?>
<title>Demande d'autorisation_retrait_DTB</title>
<?php }else{ ?>
<title>Demande d'autorisation_retrait</title>
<?php } 
if($format != 'TWG'){
  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    ...
    <tr>
        <td align="center" colspan="2">
            <h3 style="margin-block-start: 0em;text-align: center;<?php echo $margin_bt?>"  class="<?php echo $header_institution ?>">Bordereau de demande d'autorisation de retrait</h3>
        </td>
    </tr>
    ...
    <tr class="<?php echo $heder_detail; ?>">
        <td style="width: 70%">Nouvelles parts sociales souscrites</td>
    ...
    <tr class="<?php echo $heder_detail; ?>">
        ...
        <td style="width: 35%">: <?php echo $xml->body->total_ps_restant;?></td>
    </tr>
    <tr class="<?php echo $heder_detail; ?>">
