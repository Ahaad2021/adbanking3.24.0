...
<?php if($format == 'A4'){ ?>
<title>Recu_operation_diverses_Caisse_compte_A4</title>
<?php }else if($format == 'A6'){ ?>
<title>Recu_operation_diverses_Caisse_compte_A6</title>
<?php }else if($format == 'CT'){ ?>
<title>Recu_operation_diverses_Caisse_compte_CT</title>
<?php }else if($format == 'JALI'){ ?>
<title>Recu_operation_diverses_Caisse_compte_JALI</title>
<?php }else if($format == 'TWG'){ ?>
<title>Recu_operation_diverses_Caisse_compte_TWG</title>
<?php }else if($format == 'DTB'){ ?>
<title>Recu_operation_diverses_Caisse_compte_DTB</title>
<?php }else{ ?>
<title>Recu_operation_diverses_Caisse_compte</title>
<?php } 
if($format != 'TWG'){
  ...
  <table  class="borderlightgray width100" style="<?php echo $body_padding?>">
    ...
    <tr>
        <td align="center" colspan="4">
            <h3 style="margin-block-start: 0em;text-align: center;<?php echo $margin_bt?>"  class="<?php echo $header_institution ?>">Attestation opération diverse de caisse</h3>
        </td>
    </tr>
